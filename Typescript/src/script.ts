...
//now fetch contents from json file
//create an interface for contents in the json file
...
fetch('data.json')
    ...
    .then((data: DessertItem[]) => {

        //logic for total price
        const selectedItems = new Map<string, {quantity: number; price: number}>();
        ...
        data.forEach((item, index) => {
            ...
            addToCartBtn.addEventListener('click', () => {
                ...
                let dessertDiv: HTMLDivElement | null = null;
                ...
                const selectedDesserts = document.querySelector('.selected-desserts') as HTMLDivElement;
                if(selectedDesserts) {
